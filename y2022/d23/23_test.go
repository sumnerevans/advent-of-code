...
import (
	...
	"github.com/sumnerevans/advent-of-code/y2022/d23"
)
...
func Test_Day23(t *testing.T) {
	...
	_, samples, actual := lib.SetupTest(t, inputs, "23")
	...
	ok := t.Run("Part 1", func(t *testing.T) {
			...
			ok := t.Run("1 Test cases", func(t *testing.T) {
				...
				for i, sample := range samples {
					...
					t.Run(fmt.Sprintf("Test %d", i+1), func(t *testing.T) {
						day23 := &d23.Day23{}
						err := day23.LoadInput(sample)
						require.NoError(t, err)
						output := day23.Part1(true)
		...
		t.Run("2 Actual input", func(t *testing.T) {
			day23 := &d23.Day23{}
			err := day23.LoadInput(actual)
			require.NoError(t, err)
			output := day23.Part1(false)
			t.Log("=================================")
			t.Log("")
			t.Log("ACTUAL INPUT")
			t.Log("")
			...
			if err != nil {
				...
				result, answerText := lib.Submit(t, 2022, 23, 1, output)
				switch result {
	...
	t.Run("Part 2", func(t *testing.T) {
		...
		t.Run("2 Actual input", func(t *testing.T) {
			...
			if err != nil {
				...
				result, answerText := lib.Submit(t, 2022, 23, 2, output)
				switch result {
				case lib.SubmissionCorrect:
