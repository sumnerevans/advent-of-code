...
import (
	...
	"github.com/sumnerevans/advent-of-code/y2022/d14"
)
...
func Test_Day14(t *testing.T) {
	...
	_, samples, actual := lib.SetupTest(t, inputs, "14")
	...
	ok := t.Run("Part 1", func(t *testing.T) {
		...
		t.Run("2 Actual input", func(t *testing.T) {
			...
			if err != nil {
				...
				result, answerText := lib.Submit(t, 2022, 14, 1, output)
				switch result {
	...
	t.Run("Part 2", func(t *testing.T) {
		...
		t.Run("2 Actual input", func(t *testing.T) {
			...
			if err != nil {
				...
				result, answerText := lib.Submit(t, 2022, 14, 2, output)
				switch result {
				case lib.SubmissionCorrect:
