...
import (
	...
	"github.com/sumnerevans/advent-of-code/y2024/d05"
)
...
func Test_Day05(t *testing.T) {
	...
	_, samples, actual := lib.SetupTest(t, inputs, "05")
	...
	ok := t.Run("Part 1", func(t *testing.T) {
			...
			ok := t.Run("1 Test cases", func(t *testing.T) {
				...
				for i, sample := range samples {
					...
					t.Run(fmt.Sprintf("Test %d", i+1), func(t *testing.T) {
						day05 := &d05.Day05{}
						err := day05.LoadInput(sample)
						require.NoError(t, err)
						output := day05.Part1(true)
		...
		t.Run("2 Actual input", func(t *testing.T) {
			day05 := &d05.Day05{}
			err := day05.LoadInput(actual)
			require.NoError(t, err)
			output := day05.Part1(false)
			t.Log("=================================")
			t.Log("")
			t.Log("ACTUAL INPUT")
			t.Log("")
			...
			if err != nil {
				...
				result, answerText := lib.Submit(t, 2024, 05, 1, output)
				switch result {
	...
	t.Run("Part 2", func(t *testing.T) {
		...
		t.Run("2 Actual input", func(t *testing.T) {
			...
			if err != nil {
				...
				result, answerText := lib.Submit(t, 2024, 05, 2, output)
				switch result {
				case lib.SubmissionCorrect:
