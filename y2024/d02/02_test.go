...
import (
	...
	"github.com/sumnerevans/advent-of-code/y2024/d02"
)
	...
	ok := t.Run("Part 1", func(t *testing.T) {
		...
		t.Run("2 Actual input", func(t *testing.T) {
			...
			if err != nil {
				...
				result, answerText := lib.Submit(t, 2024, 02, 1, output)
				switch result {
	...
	t.Run("Part 2", func(t *testing.T) {
		...
		t.Run("2 Actual input", func(t *testing.T) {
			...
			if err != nil {
				...
				result, answerText := lib.Submit(t, 2024, 02, 2, output)
				switch result {
				case lib.SubmissionCorrect:
